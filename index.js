document.addEventListener("DOMContentLoaded", function () {
    ...
    function createConsentPopup() {
        ...
        consentPopup.innerHTML = `
            <div id="cookie-popup" style="position: fixed; bottom: 0; left: 0; width: 100%; background: white; color: black; padding: 20px; text-align: center; box-shadow: 0px -2px 10px rgba(0, 0, 0, 0.2); font-family: Arial, sans-serif;">
                <p style="margin-bottom: 15px; font-size: 16px; color: black;">
                    We use cookies to track visitors, measure ads, ad campaign effectiveness, and analyze site traffic. For more info, see our 
                    <a href="/cookie-policy" style="color: #DCC336; text-decoration: underline;">Cookie Policy</a> and 
                    <a href="privacy.html" style="color: #DCC336; text-decoration: underline;">Privacy Policy</a>.
                </p>
    ...
    function showPreferencesPopup() {
        ...
        preferencePopup.innerHTML = `
            <div id="preferences-popup" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 400px; background: white; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.3); font-family: Arial, sans-serif; color: black;">
                <h2 style="text-align: center; margin-bottom: 15px; color: black;">Privacy Preferences</h2>
                <p style="font-size: 14px; text-align: center; margin-bottom: 10px; color: black;">
